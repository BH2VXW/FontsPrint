    ...
    public class FileObj
    {
        ...
        *****************************************/
        ...
        public static string ReadFile(string Path,string charset)
        {
            ...
            {
                StreamReader f2 = new StreamReader(Path, System.Text.Encoding.GetEncoding(charset));
                s = f2.ReadToEnd();
                f2.Close();
                f2.Dispose();
            }
        ...
        *****************************************/
        ...
        public static List<string> FileList(string path)
        {
            ...
            if (Directory.Exists(path))
            {
                ...
                FileInfo[] fileInfo = dir.GetFiles();   //目录下的文件
                foreach (FileInfo fInfo in fileInfo)
                {
                    list.Add($"{fInfo.Name}");
                }
        ...
        *****************************************/
        ...
        public static string[] GetFileAttibe(string filePath)
        {
            ...
            str[0] = objFI.FullName;//详细路径
            str[1] = objFI.Name;//文件名
            str[2] = objFI.Length.ToString();//文件大小
            str[3] = objFI.CreationTime.ToString();//创建时间
            str[4] = objFI.LastAccessTime.ToString();//最后访问时间
            str[5] = objFI.LastWriteTime.ToString();//修改时间
            str[6] = objFI.DirectoryName;//所在目录
            str[7] = objFI.Extension;//扩展名
